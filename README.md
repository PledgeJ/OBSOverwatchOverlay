...
In this example, I used a batch file given to me by [Madsies](https://github.com/Madsies) which lowers the in game spectator UI to allow space for the overlay
<br>
